...
public class SuDungDichVuService {
    ...
    public SuDungDichVu getById(String maDv, String maSv, LocalDateTime ngaySuDung){ return repo.findById(maDv, maSv, ngaySuDung); }
    public int create(SuDungDichVu sddv){ return repo.save(sddv); }
//    public int update(SuDungDichVu sddv){ return repo.update(sddv); }
    public int delete(String maDv, String maSv, LocalDateTime ngaySuDung){ return repo.delete(maDv, maSv, ngaySuDung); }
}
