...
public class HoaDonThuePhongService {
    ...
    public HoaDonThuePhong getById(String maSinhVien, String maHopDong, String maHoaDon){ return repo.findById(maSinhVien, maHopDong, maHoaDon); }
    public int create(HoaDonThuePhong hd){ return repo.save(hd); }
    public int update(HoaDonThuePhong hd){ return repo.update(hd); }
    public int delete(String maSinhVien, String maHopDong, String maHoaDon){ return repo.delete(maSinhVien, maHopDong, maHoaDon); }
}
