...
public class SinhVienThuePhongService {
    ...
    public SinhVienThuePhong getById(String maSinhVien, Integer maHopDong){ return repo.findById(maSinhVien, maHopDong); }
    public int create(SinhVienThuePhong sv){ return repo.save(sv); }
    public int delete(String maSinhVien, Integer maHopDong){ return repo.delete(maSinhVien, maHopDong); }
}
